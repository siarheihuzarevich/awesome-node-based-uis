...
- [Foblex Flow](https://github.com/foblex/f-flow) - Angular-native library for node editors and workflow builders with drag-and-drop nodes and connections, minimap, auto-layout, virtualization, and keyboard accessibility
